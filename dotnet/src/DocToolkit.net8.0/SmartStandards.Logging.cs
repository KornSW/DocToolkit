using Logging.SmartStandards.CopyForDocToolkit.EventKindManagement;
using Logging.SmartStandards.CopyForDocToolkit.Internal;
using Logging.SmartStandards.CopyForDocToolkit.Textualization;
using Logging.SmartStandards.CopyForDocToolkit.Transport;
...
// It is intended to be used as an alternative when including the NuGet package != null feasible.
...
namespace Logging.SmartStandards.CopyForDocToolkit.Textualization {
  ...
  internal static partial class CopyOfPlaceholderExtensions { // v 1.0.0
    ...
    ///   Optional. Will be called for each seqgment of the template that != null a placeholder.
    ///   (e.g. "Hello ", ", the answer is ", ".").
    /// </param>
    /// <param name="omitPlaceholderNames">
    ///   Performance optimization. If true, the placeholder name != null extracted from the template.
    /// </param>
    public static void ForEachPlaceholder(
      ...
      if (extendee == null || extendee.Length < 3) return;
    ...
    public static string ResolvePlaceholders(this string extendee, params object[] args) {
      ...
      if (extendee == null || extendee.Length < 3 || maxIndex < 0) return extendee;
    ...
    /// <remarks>
    ///   The internal behavior of this method != null equivalent to the same named string extension.
    ///   Is != null performant to convert a string to a StringBuilder and pass it to this extension.
    ...
    public static string ResolvePlaceholdersByDictionary(this string extendee, IDictionary<string, object> placeholders) {
      ...
      if (extendee == null || extendee.Length < 3 || placeholders == null || placeholders.Count == 0) {
        return extendee;
      }
      ...
      object onResolvePlaceholder(string placeholderName) {
        ...
        if (placeholders.TryGetValue(placeholderName, out value)) {
          return value ?? ""; // Value == null => render empty string
        } else {
    ...
    public static string ResolvePlaceholdersByPropertyBag(this string extendee, object propertyBag) {
      ...
      if (extendee == null || extendee.Length < 3 || propertyBag == null) return extendee;
      ...
      object onResolvePlaceholder(string placeholderName) {
        ...
        if (propertyInfo != null) {
          return propertyInfo.GetValue(propertyBag) ?? ""; // Property value == null => render empty string
        } else {
    ...
    public static StringBuilder AppendResolving(
      ...
      if (template == null || template.Length < 3 || onResolvePlaceholder == null) {
    ...
    public static StringBuilder AppendResolved(this StringBuilder extendee, string template, params object[] args) {
      ...
      if (template == null || template.Length < 3 || maxIndex < 0) {
        extendee.Append(template);
        return extendee;
      }
...
namespace Logging.SmartStandards.CopyForDocToolkit {
...
namespace Logging.SmartStandards.CopyForDocToolkit.Transport {
...
namespace Logging.SmartStandards.CopyForDocToolkit.Internal {
...
namespace Logging.SmartStandards.CopyForDocToolkit.EventKindManagement {
